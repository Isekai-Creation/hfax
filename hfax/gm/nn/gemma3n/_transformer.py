...
from hfax.math import _pos_utils
from hfax.nn import _transformer
from hfax.nn.gemma3n import _config
from hfax.nn.gemma3n import _layers
from hfax.nn.gemma3n import _modules
from hfax.utils import _dtype_params
from hfax.utils import _jax_utils
from hfax.utils import _types
from hfax.vision import _token_utils
from hfax.multimodal import vision as gemma_vision
...
class Gemma3nTransformer(_transformer.Transformer):
  ...
  def _encode_and_get_inputs(
    ...
    # This is what the `hfax.text.Sampler` implementation does.
