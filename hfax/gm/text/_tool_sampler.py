...
from hfax.text import _chat_sampler
from hfax.text import _sampling
from hfax.tools import _manager as _manager_lib
from hfax.tools import _tools
...
class ToolSampler(_chat_sampler.ChatSampler):
  ...
  ```python
  sampler = hfax.text.ToolSampler(
      model=model,
      params=params,
      tools=[hfax.tools.Calculator()],
  )
