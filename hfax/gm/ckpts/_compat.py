...
import flax
from hfax.typing._common import Params  # pylint: disable=g-importing-member
import jax
...
def flatten_and_remap_params(params: Params) -> Params:
  ...
  Inverse of hfax.params.param_remapper(...) followed by
  hfax.params.nest_params(...).
