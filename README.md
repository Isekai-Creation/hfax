...
[![PyPI version](https://badge.fury.io/py/hfax.svg)](https://badge.fury.io/py/gemma)
...
[JAX](https://github.com/jax-ml/jax) library to use and fine-tune Hfax.
...
params = hfax.ckpts.load_params(hfax.ckpts.CheckpointPath.GEMMA3_4B_IT)
