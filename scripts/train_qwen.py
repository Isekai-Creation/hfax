...
def main():
    ...
    print("=== Qwen Kauldron Fine-tuning Setup ===")

    # 1. Create the tokenizer
    print("\n1. Initializing tokenizer...")
    tokenizer = hfax.text.Qwen2_5VLTokenizer()
    ...
    # 3. Define the model
    print("\n3. Defining Qwen2_5 3B model...")
    model = hfax.nn.Qwen2_5VL_3B(
        tokens="batch.input",
    )
    print("✓ Model defined.")
    ...
    trainer = kd.train.Trainer(
        ...
        init_transform=hfax.ckpts.LoadCheckpoint(
            path=hfax.ckpts.CheckpointPath.Qwen2_5VL_3B_IT,
        ),
        # Training parameters
